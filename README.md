...
[![Build Status](https://github.com/diotoborg/qui-at/workflows/CI/badge.svg)](https://github.com/diotoborg/qui-at/actions)
...
```js
import pluginJs from "@diotoborg/qui-at";
...
Open a [discussion](https://github.com/diotoborg/qui-at/discussions) or stop by our [Discord server](https://eslint.org/chat).
...
We have scheduled releases every two weeks on Friday or Saturday. You can follow a [release issue](https://github.com/diotoborg/qui-at/issues?q=is%3Aopen+is%3Aissue+label%3Arelease) for updates about the scheduling of any particular release.
